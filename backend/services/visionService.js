        ...
        contents: [
          {
            parts: [
              {
                text: 'You are analyzing a product package image. Your task is to extract ALL visible text and identify the product information with HIGH ACCURACY.\n\nSTEP 1: Read ALL text visible on the package carefully:\n- Brand names (usually at the TOP, LARGE text, often with logo)\n- Product names (main descriptive text, often in banners or large fonts)\n- Descriptions (flavor, type, variety, ingredients)\n- Size/weight information (usually at BOTTOM or SIDE, look for: FL OZ, ML, OZ, LB, COUNT, etc.)\n- Any other product details\n\nSTEP 2: Extract the following with PRECISION:\n\n1. BRAND NAME (CRITICAL - Must be accurate):\n   - Look for the MAIN brand name at the TOP of the package\n   - Usually the LARGEST text at the top, often with a logo\n   - Examples: "S.PELLEGRINO", "CATTLEMEN\'S RANCH", "Perrier", "Coca-Cola", "Nestlé"\n   - DO NOT confuse product name with brand name\n   - Brand is usually ONE or TWO words, often in ALL CAPS or stylized\n   - If you see "S.PELLEGRINO" that is the BRAND, not "TORINO TERRE"\n\n2. PRODUCT NAME (Complete description WITHOUT brand):\n   - Extract the COMPLETE product description EXCLUDING the brand name\n   - Include: Product type (e.g., "Sparkling Natural Mineral Water", "Beef Burger Patties")\n   - Include: Flavor/variety (e.g., "Bacon Cheddar", "Black Angus", "Lemon")\n   - Include: Any descriptive text (e.g., "Black Angus Bacon Cheddar Beef Burger Patties")\n   - DO NOT include the brand name in product name\n   - DO NOT use generic terms like "Bacon & Cheese" - use the FULL descriptive name\n   - If you see "TORINO TERRE" that might be a product line, not the brand\n\n3. SIZE/WEIGHT (CRITICAL - Must be exact):\n   - Look for size information at the BOTTOM or SIDE of the package\n   - Look for patterns like: "16.9 FL OZ", "500 ML", "32 OZ", "2 LB", "6 COUNT", "6 - 1/3 POUND"\n   - Include the COMPLETE size text (e.g., "16.9 FL OZ (1.06 PT) (500 ML)")\n   - If multiple sizes are shown, use the PRIMARY one (usually the largest text)\n   - Look for text like "NET WT", "NET", "SIZE", "VOLUME"\n   - DO NOT use approximate sizes - use the EXACT text from the package\n   - If you see "16.9 FL OZ (500 ML)" use that, NOT "9 FL OZ"\n\nSTEP 3: Combine into full product name:\n- Format: "Brand Product Name" (e.g., "S.Pellegrino Sparkling Natural Mineral Water")\n\nCRITICAL RULES FOR ACCURACY:\n- Read EVERY word visible on the package from TOP to BOTTOM\n- Brand name is ALWAYS at the TOP, usually the FIRST large text you see\n- Size is ALWAYS at the BOTTOM or SIDE, look for units like FL OZ, ML, OZ, LB\n- If you see "S.PELLEGRINO" at the top, that is the BRAND\n- If you see "16.9 FL OZ (500 ML)" at the bottom, that is the SIZE\n- NEVER guess or approximate - use EXACT text from the package\n- If size shows "16.9 FL OZ" do NOT use "9 FL OZ"\n- If brand shows "S.PELLEGRINO" do NOT use "TORINO TERRE"\n\nRespond ONLY with a JSON object in this exact format:\n{\n  "brand": "Exact Brand Name from TOP of Package",\n  "product": "Complete Product Description WITHOUT Brand Name",\n  "fullName": "Brand + Complete Product Description",\n  "size": "Exact Size/Weight/Quantity from BOTTOM or SIDE of Package"\n}\n\nExample for S.Pellegrino water:\n{\n  "brand": "S.Pellegrino",\n  "product": "Sparkling Natural Mineral Water",\n  "fullName": "S.Pellegrino Sparkling Natural Mineral Water",\n  "size": "16.9 FL OZ (1.06 PT) (500 ML)"\n}\n\nExample for burger patties:\n{\n  "brand": "Cattlemen\'s Ranch",\n  "product": "Black Angus Bacon Cheddar Beef Burger Patties",\n  "fullName": "Cattlemen\'s Ranch Black Angus Bacon Cheddar Beef Burger Patties",\n  "size": "6 - 1/3 POUND PATTIES NET WT 32 OZ (2 LB)"\n}\n\nIf you cannot identify any field, use "Unknown" for that field. READ ALL TEXT ON THE PACKAGE CAREFULLY FROM TOP TO BOTTOM.'
              },
              {
                inline_data: {
