        ...
        contents: [
          {
            parts: [
              {
                text: 'Look at this product image and identify the COMPLETE product information:\n1. The brand name (e.g., "Perrier", "Coca-Cola", "Nike", "Cattlemen\'s Ranch")\n2. The FULL product name including all details (e.g., "Sparkling Water", "Black Angus Bacon Cheddar Beef Burger Patties", "Running Shoes")\n3. The complete product name combining brand and ALL product details (e.g., "Perrier Sparkling Water", "Cattlemen\'s Ranch Black Angus Bacon Cheddar Beef Burger Patties")\n4. The product size/quantity (e.g., "16.9 fl oz", "500ml", "1 Each", "2.5 oz", "6 count", "2 lb")\n\nIMPORTANT:\n- Include ALL text visible on the packaging, especially product type, flavor, variety, etc.\n- For food products, include the complete description (e.g., "Black Angus Bacon Cheddar Beef Burger Patties" not just "Burger")\n- For meat products, include cut type, preparation style, etc.\n- Do NOT use generic terms like "Bacon & Cheese" - use the FULL product name from the label\n\nRespond ONLY with a JSON object in this exact format:\n{\n  "brand": "Brand Name",\n  "product": "Full Product Name with Details",\n  "fullName": "Complete Brand and Product Name",\n  "size": "Product Size/Quantity"\n}\n\nIf you cannot identify any field, use "Unknown" for that field. Focus on ALL text visible on the product label or packaging.'
              },
              {
                inline_data: {
